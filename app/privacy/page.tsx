        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem", fontSize: "0.9375rem", lineHeight: 1.75, color: "rgba(255,255,255,0.7)" }}>
          ...
          <Section title="2. Information We Collect">
            ...
            <ul style={{ marginTop: "0.75rem", paddingLeft: "1.25rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              ...
              <li><strong style={{ color: "#f0f0f0" }}>Google Business Profile data:</strong> When you connect your Google Business Profile, we request access under the <code style={{ background: "rgba(124,106,255,0.12)", padding: "0.1rem 0.4rem", borderRadius: 4, fontSize: "0.875rem", color: "#a78bfa" }}>business.manage</code> scope. This allows us to read your reviews and post replies on your behalf. We store a Google OAuth refresh token to maintain this access.</li>
          ...
          <Section title="4. Google API Usage">
            <p>ReplyBase integrates with the Google Business Profile API. Our use of data obtained through the Google API complies with the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" style={{ color: "#a78bfa", textDecoration: "none" }}>Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
            <p style={{ marginTop: "0.75rem" }}>Specifically:</p>
            <ul style={{ marginTop: "0.75rem", paddingLeft: "1.25rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              <li>We only request the <code style={{ background: "rgba(124,106,255,0.12)", padding: "0.1rem 0.4rem", borderRadius: 4, fontSize: "0.875rem", color: "#a78bfa" }}>business.manage</code> scope, which is the minimum required to read reviews and post replies.</li>
          ...
          <Section title="5. Third-Party Services">
            ...
            <ul style={{ marginTop: "0.75rem", paddingLeft: "1.25rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              <li><strong style={{ color: "#f0f0f0" }}>Supabase:</strong> We use Supabase to store your account data, business connection data, and subscription records. Data is stored securely in a Supabase-managed PostgreSQL database. See <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#a78bfa", textDecoration: "none" }}>Supabase's Privacy Policy</a>.</li>
              <li><strong style={{ color: "#f0f0f0" }}>Stripe:</strong> We use Stripe to process subscription payments. Your payment card details are handled entirely by Stripe and never stored on our servers. See <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#a78bfa", textDecoration: "none" }}>Stripe's Privacy Policy</a>.</li>
              <li><strong style={{ color: "#f0f0f0" }}>Anthropic:</strong> Review content is sent to Anthropic's API to generate reply suggestions. See <a href="https://www.anthropic.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#a78bfa", textDecoration: "none" }}>Anthropic's Privacy Policy</a>.</li>
              <li><strong style={{ color: "#f0f0f0" }}>Google:</strong> We access the Google Business Profile API on your behalf using the permissions you grant during OAuth. See <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#a78bfa", textDecoration: "none" }}>Google's Privacy Policy</a>.</li>
            </ul>
          </Section>
          ...
          <Section title="7. Your Rights">
            <p>You have the right to access, correct, or delete your personal data at any time. You can delete your account from the Settings page in your dashboard. For any data requests, contact us at <a href="mailto:hello@replybasehq.com" style={{ color: "#a78bfa", textDecoration: "none" }}>hello@replybasehq.com</a>.</p>
          </Section>
